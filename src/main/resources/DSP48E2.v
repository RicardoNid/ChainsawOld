...
//  10/22/14 - 808642 - Added  to $finish
//  End Revision:
///////////////////////////////////////////////////////////////////////////////
...
// change the tri-state
  ...
  assign ALUMODE_in[3] =  (ALUMODE[3] ^ IS_ALUMODE_INVERTED_REG[3]); // rv 0
  assign A_in[0] =  A[0]; // rv 1
  assign A_in[10] =  A[10]; // rv 1
  assign A_in[11] =  A[11]; // rv 1
  assign A_in[12] =  A[12]; // rv 1
  assign A_in[13] =  A[13]; // rv 1
  assign A_in[14] =  A[14]; // rv 1
  assign A_in[15] =  A[15]; // rv 1
  assign A_in[16] =  A[16]; // rv 1
  assign A_in[17] =  A[17]; // rv 1
  assign A_in[18] =  A[18]; // rv 1
  assign A_in[19] =  A[19]; // rv 1
  assign A_in[1] =  A[1]; // rv 1
  assign A_in[20] =  A[20]; // rv 1
  assign A_in[21] =  A[21]; // rv 1
  assign A_in[22] =  A[22]; // rv 1
  assign A_in[23] =  A[23]; // rv 1
  assign A_in[24] =  A[24]; // rv 1
  assign A_in[25] =  A[25]; // rv 1
  assign A_in[26] =  A[26]; // rv 1
  assign A_in[27] =  A[27]; // rv 1
  assign A_in[28] =  A[28]; // rv 1
  assign A_in[29] =  A[29]; // rv 1
  assign A_in[2] =  A[2]; // rv 1
  assign A_in[3] =  A[3]; // rv 1
  assign A_in[4] =  A[4]; // rv 1
  assign A_in[5] =  A[5]; // rv 1
  assign A_in[6] =  A[6]; // rv 1
  assign A_in[7] =  A[7]; // rv 1
  assign A_in[8] =  A[8]; // rv 1
  assign A_in[9] =  A[9]; // rv 1
  assign BCIN_in = BCIN;
  assign B_in[0] =  B[0]; // rv 1
  assign B_in[10] =  B[10]; // rv 1
  assign B_in[11] =  B[11]; // rv 1
  assign B_in[12] =  B[12]; // rv 1
  assign B_in[13] =  B[13]; // rv 1
  assign B_in[14] =  B[14]; // rv 1
  assign B_in[15] =  B[15]; // rv 1
  assign B_in[16] =  B[16]; // rv 1
  assign B_in[17] =  B[17]; // rv 1
  assign B_in[1] =  B[1]; // rv 1
  assign B_in[2] =  B[2]; // rv 1
  assign B_in[3] =  B[3]; // rv 1
  assign B_in[4] =  B[4]; // rv 1
  assign B_in[5] =  B[5]; // rv 1
  assign B_in[6] =  B[6]; // rv 1
  assign B_in[7] =  B[7]; // rv 1
  assign B_in[8] =  B[8]; // rv 1
  assign B_in[9] =  B[9]; // rv 1
  assign CARRYCASCIN_in = CARRYCASCIN;
  assign CARRYINSEL_in[0] =  CARRYINSEL[0]; // rv 0
  assign CARRYINSEL_in[1] =  CARRYINSEL[1]; // rv 0
  assign CARRYINSEL_in[2] =  CARRYINSEL[2]; // rv 0
  ...
  assign C_in[0] = C[0]; // rv 1
  assign C_in[10] = C[10]; // rv 1
  assign C_in[11] = C[11]; // rv 1
  assign C_in[12] = C[12]; // rv 1
  assign C_in[13] = C[13]; // rv 1
  assign C_in[14] = C[14]; // rv 1
  assign C_in[15] = C[15]; // rv 1
  assign C_in[16] = C[16]; // rv 1
  assign C_in[17] = C[17]; // rv 1
  assign C_in[18] = C[18]; // rv 1
  assign C_in[19] = C[19]; // rv 1
  assign C_in[1] =  C[1]; // rv 1
  assign C_in[20] =  C[20]; // rv 1
  assign C_in[21] =  C[21]; // rv 1
  assign C_in[22] =  C[22]; // rv 1
  assign C_in[23] =  C[23]; // rv 1
  assign C_in[24] =  C[24]; // rv 1
  assign C_in[25] =  C[25]; // rv 1
  assign C_in[26] =  C[26]; // rv 1
  assign C_in[27] =  C[27]; // rv 1
  assign C_in[28] =  C[28]; // rv 1
  assign C_in[29] =  C[29]; // rv 1
  assign C_in[2] =  C[2]; // rv 1
  assign C_in[30] =  C[30]; // rv 1
  assign C_in[31] =  C[31]; // rv 1
  assign C_in[32] =  C[32]; // rv 1
  assign C_in[33] =  C[33]; // rv 1
  assign C_in[34] =  C[34]; // rv 1
  assign C_in[35] =  C[35]; // rv 1
  assign C_in[36] =  C[36]; // rv 1
  assign C_in[37] =  C[37]; // rv 1
  assign C_in[38] =  C[38]; // rv 1
  assign C_in[39] =  C[39]; // rv 1
  assign C_in[3] =  C[3]; // rv 1
  assign C_in[40] =  C[40]; // rv 1
  assign C_in[41] =  C[41]; // rv 1
  assign C_in[42] =  C[42]; // rv 1
  assign C_in[43] =  C[43]; // rv 1
  assign C_in[44] =  C[44]; // rv 1
  assign C_in[45] =  C[45]; // rv 1
  assign C_in[46] =  C[46]; // rv 1
  assign C_in[47] =  C[47]; // rv 1
  assign C_in[4] =  C[4]; // rv 1
  assign C_in[5] =  C[5]; // rv 1
  assign C_in[6] =  C[6]; // rv 1
  assign C_in[7] =  C[7]; // rv 1
  assign C_in[8] =  C[8]; // rv 1
  assign C_in[9] =  C[9]; // rv 1
  assign D_in[0] =  D[0]; // rv 0
  assign D_in[10] = D[10]; // rv 0
  assign D_in[11] = D[11]; // rv 0
  assign D_in[12] = D[12]; // rv 0
  assign D_in[13] = D[13]; // rv 0
  assign D_in[14] = D[14]; // rv 0
  assign D_in[15] = D[15]; // rv 0
  assign D_in[16] = D[16]; // rv 0
  assign D_in[17] = D[17]; // rv 0
  assign D_in[18] = D[18]; // rv 0
  assign D_in[19] = D[19]; // rv 0
  assign D_in[1] =  D[1]; // rv 0
  assign D_in[20] =  D[20]; // rv 0
  assign D_in[21] =  D[21]; // rv 0
  assign D_in[22] =  D[22]; // rv 0
  assign D_in[23] =  D[23]; // rv 0
  assign D_in[24] =  D[24]; // rv 0
  assign D_in[25] =  D[25]; // rv 0
  assign D_in[26] =  D[26]; // rv 0
  assign D_in[2] =  D[2]; // rv 0
  assign D_in[3] =  D[3]; // rv 0
  assign D_in[4] =  D[4]; // rv 0
  assign D_in[5] =  D[5]; // rv 0
  assign D_in[6] =  D[6]; // rv 0
  assign D_in[7] =  D[7]; // rv 0
  assign D_in[8] =  D[8]; // rv 0
  assign D_in[9] =  D[9]; // rv 0
  assign INMODE_in[0] = (INMODE[0] ^ IS_INMODE_INVERTED_REG[0]); // rv 0
  assign INMODE_in[1] = (INMODE[1] ^ IS_INMODE_INVERTED_REG[1]); // rv 0
  assign INMODE_in[2] = (INMODE[2] ^ IS_INMODE_INVERTED_REG[2]); // rv 0
  assign INMODE_in[3] = (INMODE[3] ^ IS_INMODE_INVERTED_REG[3]); // rv 0
  assign INMODE_in[4] = (INMODE[4] ^ IS_INMODE_INVERTED_REG[4]); // rv 0
  assign MULTSIGNIN_in = MULTSIGNIN;
  assign OPMODE_in[0] =  (OPMODE[0] ^ IS_OPMODE_INVERTED_REG[0]); // rv 0
  assign OPMODE_in[1] =  (OPMODE[1] ^ IS_OPMODE_INVERTED_REG[1]); // rv 0
  assign OPMODE_in[2] =  (OPMODE[2] ^ IS_OPMODE_INVERTED_REG[2]); // rv 0
  assign OPMODE_in[3] =  (OPMODE[3] ^ IS_OPMODE_INVERTED_REG[3]); // rv 0
  assign OPMODE_in[4] =  (OPMODE[4] ^ IS_OPMODE_INVERTED_REG[4]); // rv 0
  assign OPMODE_in[5] =  (OPMODE[5] ^ IS_OPMODE_INVERTED_REG[5]); // rv 0
  assign OPMODE_in[6] =  (OPMODE[6] ^ IS_OPMODE_INVERTED_REG[6]); // rv 0
  assign OPMODE_in[7] =  (OPMODE[7] ^ IS_OPMODE_INVERTED_REG[7]); // rv 0
  assign OPMODE_in[8] =  (OPMODE[8] ^ IS_OPMODE_INVERTED_REG[8]); // rv 0
  assign PCIN_in = PCIN;
...
//  assign  ALU_OUT_in = {48{ALUMODE_DATA[1]}} ^ {s3[11:0],s2[11:0],s1[11:0],s0[11:0]}; // break 0 delay feedback
  assign  ALU_OUT_in = {48{ALUMODE_DATA[1]}} ^ {s3[11:0],s2[11:0],s1[11:0],s0[11:0]}; // break 0 delay feedback
