...
object DESRef {
  ...
  // setting encryption mode
  val secretKeyECB: SecretKey = (0 until 10)
    .map(_ => KeyGenerator.getInstance("DES").generateKey())
    .filter(key => BigInt(key.getEncoded) > 0)
    .head // get a positive one
...
object DES {
  ...
  def des(dataIn: Bits, key: Bits): Bits = {
    ...
    // permutation data
    val IPData = getBigSeqFromHex(
      "58 50 42 34 26 18 10 2 60 52 44 36 28 20 12 4 62 54 46 38 30 22 14 6 64 56 48 40 32 24 16 8 57 49 41 33 25 17 9 1 59 51 43 35 27 19 11 3 61 53 45 37 29 21 13 5 63 55 47 39 31 23 15 7"
    )
      .map(_.toInt)
    val EData = getBigSeqFromHex(
    ...
    val PData = getBigSeqFromHex("16 7 20 21 29 12 28 17 1 15 23 26 5 18 31 10 2 8 24 14 32 27 3 9 19 13 30 6 22 11 4 25")
      .map(_.toInt)
    val PC1Data = getBigSeqFromHex(
      "57 49 41 33 25 17 9 1 58 50 42 34 26 18 10 2 59 51 43 35 27 19 11 3 60 52 44 36 63 55 47 39 31 23 15 7 62 54 46 38 30 22 14 6 61 53 45 37 29 21 13 5 28 20 12 4"
    )
      .map(_.toInt)
    val PC2Data = getBigSeqFromHex(
    ...
    val S2Data = constructSBox(
      "0 14 4 13 1 2 15 11 8 3 10 6 12 5 9 0 7 1 0 15 7 4 14 2 13 1 10 6 12 11 9 5 3 8 2 4 1 14 8 13 6 2 11 15 12 9 7 3 10 5 0 3 15 12 8 2 4 9 1 7 5 11 3 14 10 0 6 13"
    )
    val S3Data = constructSBox(
      "0 14 4 13 1 2 15 11 8 3 10 6 12 5 9 0 7 1 0 15 7 4 14 2 13 1 10 6 12 11 9 5 3 8 2 4 1 14 8 13 6 2 11 15 12 9 7 3 10 5 0 3 15 12 8 2 4 9 1 7 5 11 3 14 10 0 6 13"
    )
    val S4Data = constructSBox(
      "0 14 4 13 1 2 15 11 8 3 10 6 12 5 9 0 7 1 0 15 7 4 14 2 13 1 10 6 12 11 9 5 3 8 2 4 1 14 8 13 6 2 11 15 12 9 7 3 10 5 0 3 15 12 8 2 4 9 1 7 5 11 3 14 10 0 6 13"
    )
    val S5Data = constructSBox(
      "0 14 4 13 1 2 15 11 8 3 10 6 12 5 9 0 7 1 0 15 7 4 14 2 13 1 10 6 12 11 9 5 3 8 2 4 1 14 8 13 6 2 11 15 12 9 7 3 10 5 0 3 15 12 8 2 4 9 1 7 5 11 3 14 10 0 6 13"
    )
    val S6Data = constructSBox(
      "0 14 4 13 1 2 15 11 8 3 10 6 12 5 9 0 7 1 0 15 7 4 14 2 13 1 10 6 12 11 9 5 3 8 2 4 1 14 8 13 6 2 11 15 12 9 7 3 10 5 0 3 15 12 8 2 4 9 1 7 5 11 3 14 10 0 6 13"
    )
    val S7Data = constructSBox(
      "0 14 4 13 1 2 15 11 8 3 10 6 12 5 9 0 7 1 0 15 7 4 14 2 13 1 10 6 12 11 9 5 3 8 2 4 1 14 8 13 6 2 11 15 12 9 7 3 10 5 0 3 15 12 8 2 4 9 1 7 5 11 3 14 10 0 6 13"
    )
    val S8Data = constructSBox(
      "0 14 4 13 1 2 15 11 8 3 10 6 12 5 9 0 7 1 0 15 7 4 14 2 13 1 10 6 12 11 9 5 3 8 2 4 1 14 8 13 6 2 11 15 12 9 7 3 10 5 0 3 15 12 8 2 4 9 1 7 5 11 3 14 10 0 6 13"
    )
    ...
    def fOperation(data: Bits, key: Bits) = {
      ...
      val afterS: UInt = groupsForS
        .zip(sBoxes)
        .map { case (bools, sBox) => sBox(bools.asBits()) }
        .reduce(_ @@ _)
