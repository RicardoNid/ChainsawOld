...
object ModularReduction {
  ...
  /** modular reduction for a specific Zp in which p = k * 2^m^ + 1, like Montgomery modular reduction, this won't give an exact mod result, so you need regard
    * it as a different "representation"
    *
    * @see
    *   Speeding up the Number Theoretic Transform for Faster Ideal Lattice-Based Cryptography [[http://eprint.iacr.org/2016/504.pdf]] for original KRED
    * @see
    *   High-Speed NTT-based Polynomial Multiplication Accelerator for CRYSTALS-Kyber Post-Quantum Cryptography [[https://eprint.iacr.org/2021/563.pdf]] for
    *   K2RED
    * @see
    *   [[]] for authors explanation // TODO: write this
    * @see
    *   [[crypto]] for hardware implementation
    * @return
    *   ret === K^2^ * c mod p
    */
