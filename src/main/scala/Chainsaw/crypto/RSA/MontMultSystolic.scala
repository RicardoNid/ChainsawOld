...
case class MontMultSystolic(config: MontConfig) extends Component {
  ...
  /** @see
    *   [[https://www.notion.so/RSA-ECC-59bfcca42cd54253ad370defc199b090 "MontSystolic-PEs" in this page]]
    */
  // BLOCK PEs
  ...
  /** @see
    *   [[https://www.notion.so/RSA-ECC-59bfcca42cd54253ad370defc199b090 "MontSystolic-Connections" in this page]]
    */
  // BLOCK Connections
  ...
  /** @see
    *   [[https://www.notion.so/RSA-ECC-59bfcca42cd54253ad370defc199b090 "MontSystolic-Outputs" in this page]]
    */
