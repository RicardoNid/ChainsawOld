...
/** The report of a standard simulation, you can print it directly, or utilize its attributes
  ...
  * @param totalCase
  *   number of all testCases
  * @param log
  *   logs on all testCases that failed, each log is a String
  * @param validLog
  *   logs on all testCases that passed
  */
...
trait DSPSim[inputType <: Data, outputType <: Data, testCaseType, testResultType] extends Component {
  ...
  /** Define the conditions by which you regard ref and dut as the same
    *
    * @param refResult
    *   - golden truth generated by the reference model
    * @param dutResult
    *   - output generated by DUT
    * @return
    */
  ...
  /** Message String to log when !isValid(refResult, dutResult)
    *
    * @param testCase
    *   - testCase corresponding to the result
    * @param refResult
    *   - golden truth generated by the reference model
    * @param dutResult
    *   - output generated by DUT
