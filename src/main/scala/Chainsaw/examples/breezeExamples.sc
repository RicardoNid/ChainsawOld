...
import breeze.linalg.{csvread, csvwrite, lowerTriangular, tile, upperTriangular}
...
v2(-1 to 0 by -1) // combine them, we get a "reverse" function
...
import breeze.linalg.{argmax, argmin, max, min}
// +, *, /, and inplace version
// +, *, /, and inplace version
m0 + m1
...
import breeze.linalg.{det, eig, eigSym, inv, norm, pinv, svd}
