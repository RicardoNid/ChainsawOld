...
//
//  def apply(configVector: AOpConfig): AOperation =
...
//      case AOPsign.ADD => ((u << aOperation.j) + (v << aOperation.k)) >> aOperation.r
//      case AOPsign.SUBNEXT => ((u << aOperation.j) - (v << aOperation.k)) >> aOperation.r
//      case AOPsign.SUBPREV => ((v << aOperation.k) - (u << aOperation.j)) >> aOperation.r
//    }
...
//  }
//
//  def AReverse(w: Int, u: Int, v: Int): AOpConfig = {
