...
case class RadixRFFT(N: Int = 256, dataWidth: Int, coeffWidth: Int, factors: Seq[Int]) extends Component {
...
object RadixRFFT extends App {
  GenRTL(new RadixRFFT(16, 16, 16, Seq(4, 4)), name = "FFT")
  val report = VivadoSynth(new RadixRFFT(N = 256,
