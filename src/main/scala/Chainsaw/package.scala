...
package object Chainsaw extends RealFactory {
  ...
  * following methods are designed for Real type*/
  ...
  case class coreHardware(reference: String) extends scala.annotation.StaticAnnotation

  case class peripheralHardware(reference: String) extends scala.annotation.StaticAnnotation

  case class adaptiveHardware() extends scala.annotation.StaticAnnotation
